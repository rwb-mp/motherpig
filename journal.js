const schedule = [
  ...
  opp: 'at San Francisco',
  score: 'L 3-2',
  recap: `Jack Leiter (2-0, 0.90) vs. Jordan Hicks (1-3, 6.59). Leading off the bottom of the 9th with the score 2-2, the Giants' Heliot Ramos tapped one to the left of the mound. Luke Jackson threw wild to 1B and Jake Burger threw wild to 3B allowing Ramos to score the walkoff run. In the 1st inning after doubles down the 3B line by Burger and Pederson, Semien blooped a Texas Leaguer behind SS to score them both. A single and 3 walks in the 1st inning gave the Giants their first run. Ramos scored to tie the game in the 4th after leading off with a single. Leiter's line was 2 runs on 2 hits and 4 walks with 3 K's in 3-1/3 innings. Pederson led off the 6th with a triple to deep CF, but Garcia chased 3 pitches out of the zone to strike out, Semien grounded out, and Ahmed popped out to strand him. The Rangers' bullpen pitched 4-2/3 shutout innings but the Rangers were 2 for 10 with RISP. The Rangers fell out of 1st place for the first time since April 14.`
  },
  {
  id: 'apr28',
  date: 'April 28',
