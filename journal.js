const schedule = [
  ...
  opp: 'at New York Mets',
  score: 'L 5-2',
  recap: `Jacob Latz (2-0, 2.91) vs. Nolan McLean (4-1, 1.42). Latz ran his pitch count up early by walking 4 batters in the 1st 2 innings but worked out of jams in both innings. The Mets took a 1-0 lead in the 5th when they led off with a double and moved the runner around with a couple of ground outs. A home run off Cole Winn in the 6th made the score 2-0. After wasting scoring chances in the 5th and 6th, the Rangers scored twice in the 7th when Helman led off with a single. Two outs later, Smith was hit by the pitch and Langford walked loading the bases. Pederson hit a clutch 2-RBI single to tie the score 2-2. Webb, Milner, Garcia, and Armstrong pitched 3-2/3 shutout innings to send the game to extras. In the top of the 10th, Langford moved the free runner to third on a fly out, but Garcia struck out and Tellez popped out to 3rd to end the Ranger half. Curvelo pitched the 10th for Texas. The 1st batter was intentionally walked and a 390-foot home run to right gave the Mets the walkoff win. Texas was 1-for-8 with RISP. Thanks to an Astros loss, the Rangers remained 2 games behind for the 3rd wild card. Record: 79-71.`
  },
]
