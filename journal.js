...
`
  ...
  opp: 'at Arizona',
  score: 'W 7-5',
  recap: `Patrick Corbin (7-9, 4.33) vs. Ryne Nelson (7-3, 3.53). The Mariners lost earlier, so a win would move the Rangers to within 1-1/2 games of the final wild card spot. Things looked bleak early. Corbin gave up solo home runs to the first 2 batters he faced. Arizona added another solo homer in the 2nd. Cody Freeman answered with a 391-foot 2-run shot in the 3rd after a Higashioka single to make the score 3-2. Langford homered 382-feet to left in the 6th to tie the game 3-3. Corbin settled down to pitch 3-2/3 innings of hitless ball into the 6th when the DBacks broke the tie with a single and a triple. Jacob Webb gave up another run in the 6th on a double to make the score 5-3. Dylan Moore started the top of the 9th with a single and scored on a Burger triple. Cody Freeman had a clutch 2-out single to right to tie the game 5-5. Chris Martin--in his first game off the IL--pitched a scoreless 9th. With the free runner on second base in the 10th, Duran walked and Osuna singled home both runners to give the Rangers their first lead of the game 7-5. Armstrong pitched a perfect 10th to close out the win.`
  },
]
