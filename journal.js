const schedule = [
  ...
  opp: 'Chicago Cubs',
  score: 'L 7-1',
  recap: `Kumar Rocker (1-3, 4.71) vs. Ben Brown (1-1, 2.10). It was a bullpen game for the Cubs. Rocker had some bad luck in the 1st when the Cubs hit a bloop that landed on the 3rd base line, and followed with a flair single through the left side for an early 1-0 lead. Rocker retired the next 7 batters, but issued a leadoff walk in the 4th that was followed by a HR to make Chicago's lead 3-0. Rocker threw 39 pitches in the 4th and was replaced with 2 outs by Quantrill who got the last out of the inning. The Cubs scored 4 in Quantrill's 3-1/3 innings, but only 1 was earned after Foscue was charged with an error for colliding with Seager on a reutine grounder up the middle. The lone Ranger came in the 5th when Carter and Pederson drew walks to begin the inning and Foscue singled home a run. The Rangerts only have 2 hits in the game off 4 Cubs pitchers. Record: 17-21.`
  },
  {
  id: 'may9',
  date: 'May 9',
