const schedule = [
  ...
  opp: 'Athletics',
  score: 'L 2-1',
  recap: `Kumar Rocker (1-1, 3.48) vs. J.T. Ginn (0-0, 3.74). The Rangers had baserunners in every inning except the 9th, and the leadoff hitter reached 6 times. Texas had a chance for a big inning in the 6th when Jung led off with a double and scored on a throwing error on Carter's sacrifice bunt. Burger then walked and Smith bunted for a hit to load the bases with no outs. Jansen and Haggerty struck out and Nimmo lined out to centerfield, and the Rangers had to settle for 1 run. Texas went 1-for-20 with runners on base. Rocker had a shaky 1st inning when he issued a pair of 2-out walks followed by a triple that scored them both. He then settled down to pitch 5 scoreless innings. Alexander, Collyer, and Gray pitched 3 shutout innings in relief. Jung went 2-for-4 with 2 doubles and raised his average to .378 in April. Record: 14-14.`
  },
  {
  id: 'apr27',
  date: 'April 27',
