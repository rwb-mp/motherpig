const schedule = [
  ...
  opp: 'Seattle',
  score: 'W 5-4',
  recap: `MacKenzie Gore (6-8, 4.80) vs. Bryce Miller (4-4, 2.27). Langford solo homered 384 feet to left to begin the scoring in the 1st. Gore couldn't get the shutout inning and the Mariners tied it in the 2nd. Duran led off the 4th with a single. Two outs later, Burger homered 362 feet to right for a 3-1 lead. Again, Gore couldn't get the shutdown inning and Seattle tied the game 3-3 in the 5th. Nimmo hit a 1-out single in the 6th and Carter followed with a walk. Burger singled home Nimmo and Carter moved to 3rd. Lopez laid down a perfect squeeze bunt to score Carter with the 5th Ranger run. Diaz singled to load the bases with 1 out, but Osuna struck out and Pederson popped out to 3rd to waste the scoring opportunity. Gray, Junis, Alexander, and Winn teamed up to throw 3 shutout relief innings. Latz allowed a run in the 9th on a double, a groundout, and a wild pitch, but still got his 20th save. Record: 52-51.`
  },
  {
  id: 'jul25',
  date: 'July 25',
