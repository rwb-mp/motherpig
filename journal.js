const schedule = [
  ...
  opp: 'at Atlanta',
  score: 'W 7-6',
  recap: `MacKenzie Gore (5-8, 4.63) vs. Owen Murphy (0-1, 2.25). Pederson homered to start the game, but Gore had a rough 2nd inning in which Atlanta took a 4-1 lead. The Rangers scored 2 in the 3rd and loaded the bases with 1 out, but Duran struck out on a pitch out of the zone and Carter flew out to right. The Braves answered with a solo HR in the 3rd to make the score 5-3. Duran doubled to lead off the 6th and Carter homered to right to tie the game at 5-5. After a 1-out walk to Higashioka, consecutive 2-out singles by Langford and Jung loaded the bases. Nimmo singled in 2 runs to give Texas their 1st lead of the game at 7-5. The Rangers had a chance to blow the game open in the 7th when they loaded the bases with 1 out, but Foscue hit into an inning-ending DP. Atlanta scored in the 7th to draw to within a run. Junis got the 1st 2 outs in the 8th before a Braves' single. Latz got the last 4 outs for his 19th save of the season. Pederson, Langford, Jung, Nimmo, and Carter each had 2 hits for Texas. Record: 50-48.`
  },
  {
  id: 'jul19',
  date: 'July 19',
