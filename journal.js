const schedule = [
  ...
  opp: 'Arizona',
  score: 'W 7-4',
  recap: `MacKenzie Gore (2-3, 5.18) vs. Zac Gallen (1-3, 4.70). Schumacher put Pederson in the leadoff spot and it paid off as Pederson started the game with a 380-foot HR for the early lead. Burger hit a flair single to rightfield in the 2nd inning to score the 2nd Ranger run after Duran walked and Osuna was hit by the pitch. Duran solo homered 338 feet into the rightfield corner for the 3rd Ranger run. The Rangers broke the game open in the 5th when they batted around and scored 4 runs on 4 singles and a triple by Nimmo. Gore pitched his best game as a Ranger, throwing 8 innings and allowing just 1 run and only 4 baserunners. Collyer, who had not allowed a run in his 1st 11 appearances, came in for the 9th and loaded the bases on 3 walks and then allowed a single. Latz retired the next 3 hitters to secure the win. Nimmo and Burger each had 3 hits. Record: 20-22.`
  },
  {
  id: 'may13',
  date: 'May 13',
