const schedule = [
  ...
  opp: 'Tampa Bay',
  score: 'W 5-2',
  recap: `The Rangers took a 4-run lead in the 3rd on 5 consecutive base hits by Smith, Higashioka, Taveras, Semien, and Seager against Tampa Bay's Zack Littell. Littell was coming off a start against Colorado in which he gave up just 1 run on 4 hits in 6 innings, walking none and striking out 7. Tyler Mahle shook off his control issues in his first start and was effective against a good hitting Rays team, throwing 5 shutout innings and not allowing a runner past first base. The Rays countered with 2 runs in the 7th, but Josh Smith homered in the Rangers' half to extend the lead to 3. Luke Jackson pitched a perfect 9th for his 4th save.`
  },
  {
  id: 'apr5',
  date: 'April 5',
  ...
  opp: 'at Boston',
  score: 'L 6-4',
  recap: `Tyler Mahle (3-1, 1.19) vs. Tanner Houck (0-2, 6.38). Jonah Heim homered twice off Houck in a 4-1 win the 2nd game of the season. Rangers scored in the 3rd after a Heim walk and a Jung double, but Semien grounded out softly to leave the bases loaded. Garcia solo-homered in the 4th for the Rangers' 2nd run. Bregman and Wilyer Abreu homered in the Boston half to tie the game 2-2. A Seager lead-off single followed by a Pederson double set the Rangers up in the 5th. After Semien grounded out softly on the first pitch he saw, Garcia scored Seager on a sac fly to CF to give the Rangers a 3-2 lead. Mahle left with the lead after 5 innings having given up 2 runs on 4 hits and a walk with 0 K's. The bullpen faltered as Milner, Webb, Garcia, and Boushley gave up 4 runs in relief. Bregman had the big hit in the 7th with a 2-run single. Abreu homered again in the 8th to extend the Red Sox lead to 6-3. Jung homered to lead off the 9th, but after a walk to Langford, Aroldis Chapman got Seager to fly out deep and struck out Crim to end the game. The Rangers were 0-for-10 with RISP.`
  },                       
]
