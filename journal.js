const schedule = [
  ...
  score: 'L 8-7',
  recap: `Kumar Rocker (0-1, 3.60) vs. Tyler Glasnow (1-0, 3.00). The vaunted Dodger lineup had 15 base hits, but 3 double plays by the Rangers' defense helped keep the game within reach. Rocker gave the team a chance to win despite allowing 2 solo HR's to Max Muncy. He left with a 4-3 lead after throwing 85 pitches over 5 innings, walking 2 and striking out 5. Seager hit a 3-run HR in the 3rd and Langford hit a solo in the 5th. Garcia pitched the 6th and the Dodgers turned the game around when a leadoff walk and 3 base hits made the score 5-4 Dodgers. LA added 2 more in the 8th on an Andy Pages HR. Pederson singled to start the 9th and Carter homered to right to make it 7-6. After 2 were out, Jung singled, Nimmo was intentionally walked, and Duran singled to left to score the game tying run. Latz struck out the 1st 2 hitters he faced in the bottom of the inning, but Muncy homered for the 3rd time for the walkoff win. Record: 7-6.`
  },
  {
  id: 'apr11',
  date: 'April 11',
