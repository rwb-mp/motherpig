...
`
  ...
  opp: 'at Athletics',
  score: 'L 5-2',
  recap: `Kumar Rocker (1-2, 6.38) vs. JP Sears (2-2, 3.13). Sears continued his dominance over Texas, earning his fourth consecutive win against the Rangers. Kumar Rocker struggled out of the gate, allowing four runs on six hits in a rough first inning. The Rangers' offense managed just seven hits against four Oakland pitchers and struck out 11 times. Wyatt Langford provided a spark with a solo home run in the fourth, and Texas added a second run in the sixth on a Garcia ground out after a  Kevin Pillar single and a Langford walk. Joc Pederson snapped an 0-for-41 skid with a ninth-inning double. Before the game, the Rangers placed Corey Seager on the 10-day IL with hamstring soreness.`
  },
  {
  id: 'apr24',
  date: 'April 24',
...
`
  ...
  score: 'W 2-0',
  recap: `Nathan Eovaldi (1-2, 2.64) vs. Justin Verlander (0-1, 5.47). Eovaldi delivered another dominant performance scattering three hits and a walk over six scoreless innings, striking out seven. He was backed by strong defense, including standout plays from Dustin Harris in center field and Josh Jung at third base. The bullpen trio of Chris Martin, Robert Garcia, and Luke Jackson combined for three hitless innings with seven strikeouts. Jackson earned his eighth save. Wyatt Langford led the offense, going 3-for-4 with two doubles. He drove in the first run in the third inning after a Jake Burger leadoff double. Langford doubled again in the sixth and scored on a Joc Pederson RBI single. The Rangers totaled seven hits in the win and notched their second shutout of the season.`
  },
  {
  id: 'apr26',
  date: 'April 26',
  ...
  opp: 'Athletics',
  score: 'W 15-2',
  recap: `Jacob deGrom (0-1, 3.33) vs. Jacob Lopez (0-0, 0.00) The Rangers’ offense erupted for 18 hits and nine walks, backing a dominant outing from Jacob deGrom. Facing Triple-A call-up Jacob López, who was filling in for the injured J.T. Ginn, Texas capitalized early and often — highlighted by an eight-run sixth inning. deGrom was in complete control, needing just 65 pitches to throw six shutout innings. He allowed four hits, struck out seven, and didn’t issue a walk. Dane Dunning, making his season debut after being recalled from Round Rock, handled the final three innings. Smith, Semien, and Taveras each had three hits for the Rangers.`
  },
  {
  id: 'apr30',
  date: 'April 30',
  ...
  opp: 'at Detroit',
  score: 'W 10-3',
  recap: `Jacob deGrom (2-1, 2.61) vs. Jack Flaherty (1-4, 3.79). The Rangers launched five no-doubt homers to right field. Josh Smith (389 ft) and Corey Seager (403 ft) went back-to-back in the first, Evan Carter added a 390-footer in the second, Joc Pederson homered 401 feet in the fourth, and Seager struck again with a 393-foot shot in the seventh. Jacob deGrom struck out 10 over 5 innings, allowing 2 runs on 5 hits and a walk. Milner, Armstrong, and Jackson combined to finish the game, giving up a run in four innings of relief. Rangers pitchers totaled 13 strikeouts on the night.`
  },
  {
  id: 'may11',
  date: 'May 11',
  ...
  opp: 'Seattle',
  score: 'L 6-4',
  recap: `Jack Leiter (4-5, 4.55) vs. Luis Castillo (4-5, 3.69). For the third straight game, the Rangers and Mariners played extra innings. Evan Carter led the offense with three hits and scored the game’s first run in the second inning on a Jung RBI single. Leiter was sharp, leaving a 1–1 game after six strong innings, allowing seven hits, no walks, and striking out seven. Jacob Latz and Luke Jackson combined for three scoreless innings to push the game to extras. But in the 10th, Jackson gave up two runs to the Mariners. Seager responded with his third home run of the series, a two-run shot to tie it at 3–3. Cole Winn tossed a scoreless 11th, but the Rangers failed to capitalize. Jonah Heim executed a sacrifice bunt to move the free runner to third, but Jung and Higashioka struck out, ending the threat. In the 12th, Seattle took full advantage, plating three runs—capped by a Mitch Garver two-run homer—to put the game away. The Rangers again struggled in key spots, going 2-for-15 with runners in scoring position. Adolis García, hitting cleanup the past two games, is 0-for-9 with six strikeouts over that span.`
  },
  {
  id: 'jun30',
  date: 'June 30',
  ...
  opp: 'at San Diego',
  score: 'W 7-4',
  recap: `Patrick Corbin (4-7, 4.26) vs. Stephen Kolek (3-3, 3.73). Higashioka had five RBI's, with at least one in each of his four plate appearances. The bottom of the order that included Heim, Burger, and Higashioka combined to go 6-for-9. Smith hit the first pitch of the game 409 feet for a leadoff home run. Smith and Langford made sensational plays in the field to create outs. Corbin turned in another quality start, allowing two runs on six hits and a walk over six innings, striking out three. The Padres loaded the bases in the seventh against Luke Jackson on two walks and a single. Milner came in and allowed a pair of sacrifice flies but limited the damage to preserve a 6–4 lead. The Rangers scored again in the eighth. In the ninth, the Padres loaded the bases with two outs against Garcia, but Armstrong got the final out to secure the save.`
  },
]
