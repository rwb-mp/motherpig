const schedule = [
  ...
  opp: 'at New York Mets',
  score: 'L 5-2',
  recap: `Jacob Latz (2-0, 2.91) vs. Nolan McLean (4-1, 1.42). Latz ran his pitch count up early by walking 4 batters in the 1st 2 innings but worked out of jams in both innings. The Mets scored in the 5th when they led off with a double and moved the runner around with a pair of ground outs. A home run off Cole Winn in the 6th made the score 2-0. After wasting scoring chances in the 5th and 6th, Helman led off the 7th with a single. Two outs later, Smith was hit by the pitch and Langford walked loading the bases. Pederson hit a clutch 2-RBI single to tie the score 2-2. After Higashioka singled to start the 9th, Duran--pinch running for Higashioka--stole second and moved to 3rd on a Freeman sacrifice bunt. Smith hit a weak line drive to short and Duran--running on contact--was doubled off to kill the threat. Webb, Milner, Garcia, and Armstrong pitched 3-2/3 shutout innings to send the game to extras. In the top of the 10th, Langford moved the free runner to third on a fly out, but Garcia struck out and Tellez popped out to end the Ranger half. In the bottom of the 10th, Curvelo intentionally walked the 1st batter and surrendered a 390-foot home run to right gto give the Mets the walkoff win. Texas was 1-for-8 with RISP. Thanks to an Astros loss, the Rangers remained 2 games behind the Astros for the 3rd wild card. Record: 79-71.`
  },
]
