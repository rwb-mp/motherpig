const schedule = [
  ...
  opp: 'at New York Mets',
  score: 'L 5-2',
  recap: `Jacob Latz (2-0, 2.91) vs. Nolan McLean (4-1, 1.42). Latz ran his pitch count up early by walking 2 batters in the 1st and 2 more batters in the 2nd, but worked out of jams in both innings. The Mets scored in the 5th when they led off with a double and moved the runner around with a pair of ground outs. A home run off Cole Winn in the 6th made the score 2-0. After the Rangers wasted scoring chances in the 5th and 6th, Helman led off the 7th with a single. Two outs later, Smith was hit by the pitch and Langford walked loading the bases. Pederson hit a clutch 2-RBI single to tie the score 2-2. The Rangers had a runner on 3rd with 1 out in the 9th and the 10th and failed to score both times. In the 9th, Smith hit a weak line drive to short and Duran--running on contact--was doubled off to kill the scoring chance. Webb, Milner, Garcia, and Armstrong pitched 3-2/3 shutout innings to send the game to extras. In the 10th, Garcia struck out and Tellez popped out to end another scoring opportunity. The Mets homered off Curvelo in the bottom of the 10th for the walkoff win. Thanks to an Astros loss, the Rangers remain 2 games behind the Astros for the 3rd wild card. Record: 79-71.`
  },
]
