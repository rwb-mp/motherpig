...
`
  ...
  opp: 'Seattle',
  score: 'L 6-4',
  recap: `Jack Leiter (4-5, 4.55) vs. Luis Castillo (4-5, 3.69). For the third straight game, the Rangers and Mariners played extra innings. Evan Carter led the offense with three hits and scored the game’s first run in the second inning on a Josh Jung RBI single. Jack Leiter was sharp, leaving a 1–1 game after six strong innings, allowing one run on seven hits, no walks, and striking out seven. Jacob Latz and Luke Jackson combined for three scoreless innings to push the game to extras. But in the 10th, Jackson gave up two runs to the Mariners. Seager responded with his third home run of the series, a two-run shot to tie it at 3–3. Cole Winn tossed a scoreless 11th, but the Rangers failed to capitalize. Jonah Heim executed a sacrifice bunt to move the free runner to third, but Jung and Kyle Higashioka struck out, ending the threat. In the 12th, Seattle took full advantage, plating three runs—capped by a Mitch Garver two-run homer—to put the game away. The Rangers again struggled in key spots, going 2-for-15 with runners in scoring position. Adolis García, hitting cleanup the past two games, is now 0-for-9 with six strikeouts over that span.
