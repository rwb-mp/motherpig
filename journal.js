const schedule = [
  ...
  opp: 'at Boston',
  score: 'L 6-4',
  recap: `Tyler Mahle (3-1, 1.19) vs. Tanner Houck (0-2, 6.38). Jonah Heim homered twice off Houck in a 4-1 win the 2nd game of the season. The bullpen consisting of Milner, Webb, Garcia, and Boushley turned a 3-2 lead into a 6-3 deficit. Mahle's line was 2 runs on 4 hits over 5 innings with a walk and 0 K's. Wilyer Abreu and Alex Bregman did most of the damage for Boston. Aroldis Chapman pitched the 9th and Jung homered to start the inning. Seager and Crim batted as the tying run, but Seager flew out to the warning track and Crim struck out to end the game. The Rangers went 0-for-10 with RISP led by Semien who went 0-for-4 and stranded 6 baserunners. Garcia hit a solo-homer and had a sac fly in 4 plate appearances. Pederson had a single, a double, and a walk in 3 plate appearances. Evan Carter went 0-for-4 in his 2nd game back.`
  },                       
]
