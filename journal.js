const schedule = [
  ...
  opp: 'at Athletics',
  score: 'L 4-3',
  recap: `Jacob deGrom (0-1, 3.32) vs. J.T. Ginn (1-1, 3.69). The Rangers entered the 9th with a 3-2 lead, but an error by Taveras and a blown save by Luke Jackson cost the Rangers the game and the series. All the Rangers' runs came in the 4th when Jung homered 414 feet to LF and Heim followed with a 405-foot blast to RF. After Burger grounded out Taveras homered 389 feet to right-center to give the Rangers a 3-2 lead. Later in the same inning the Rangers loaded the bases with 2 outs, but Garcia grounded out to 3B to end the threat. Both A's runs came in the 3rd when Langford lost an easy fly ball in the lights to put runners on 2nd and 3rd with 1 out. The next batter grounded back to the pitcher for what should have been the third out, but Soderstrom followed with a double to score both runners. The Rangers wasted an opportunity in the 1st when Langford doubled with one out, but Garcia struck out on an apparent ball four and Jung popped out to 2B. The Rangers managed only one baserunner after the 4th inning. In the 9th Max Schuemann walked and scored from first on a single by Luis Urias that Taveras booted in CF. After a flyout to LF, Jacob Wilson singled in the winning run and the A's had the walk-off win.`
  },
  {
  id: 'apr25',
  date: 'April 25',
