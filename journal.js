const schedule = [
  ...
  opp: 'at Athletics',
  score: '8:40',
  recap: `MacKenzie Gore (2-0, 2.76) vs. Jeffrey Springs (2-0, 1.47). Nimmo doubled to open the game. After soft tappers back to the mound by Langford and Seager, Burger singled to score him. Gore was sharp to open the game, but with 2 outs in the 3rd, a double, a pair of walks, and a single plated 2 for the Athletics. He pitched out of trouble after issuing 2 more walks in the 4th. Finally, a 2-out walk in the 5th ended Gore's day. His line was 4-2/3 innings, 2 runs on 3 hits and 6 walks with 5 K's. Martin, Garcia, and Alexander pitched 3-1/3 shutout innings. The offense had only 2 base hits over the final 8 innings and went 1-for-8 with RISP. Jung had a 1-out double in the 7th, but McCutcheon and Jansen stranded him. With 2 outs in the 8th, Langford and Seager walked. Burger hit a line drive 101 mph, but it went right at the leftfielder to end the inning. Carter, Jung, and Pederson went quietly in the 9th. Record: 9-8. `
  },
  {
  id: 'apr15',
  date: 'April 15',
