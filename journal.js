...
`
  ...
  opp: 'Chicago White Sox',
  score: 'W 5-4',
  recap: `Jacob deGrom (6-2, 2.12 ) vs. Mike Vasil (3-2, 2.18). Adolis García delivered a walk-off single in the 11th inning to give the Rangers a 5–4 win, despite a frustrating night at the plate for the team. Texas went just 4-for-23 with runners in scoring position and left 17 runners on base. The Rangers loaded the bases or had multiple runners on in five different innings—each time with only one out—but managed just one run from those chances. Trailing 2–1 in the seventh, Corey Seager reached on a called ball four that should’ve been called strike three, and came around to score on a Marcus Semien double and a wild pitch to tie the game. Later in the inning, Texas stranded a runner at second with no outs as Burger, Jung, and García struck out in order. In the eighth, Josh Smith scored the go-ahead run on a costly error by the Twins' shortstop that should have ended the inning. But the lead didn’t last: with two outs in the ninth, Robert García was brought in to record the final out but allowed a game-tying double. Ultimately, Adolis García singled home the winning run and sealed a missed-opportunities kind of win for Texas.`
  },
]
