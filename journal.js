...
`
  ...
  opp: 'Seattle',
  score: 'W 3-2',
  recap: `Kumar Rocker (3-4, 6.68) vs. Bryan Woo (7-4, 3.12). For the second straight game, the Rangers and Mariners went to extra innings, and this time it was Texas that came out on top with a 3–2 walk-off win in the 10th. Kumar Rocker turned in a strong outing, allowing two runs on four hits and a walk over six innings while striking out six. After Josh Smith reached on an error in the third, Corey Seager followed with a two-run homer to give the Rangers a 2–1 lead. Seattle tied it in the sixth, but the Texas bullpen came through. Hoby Milner, Chris Martin, and Robert Garcia each tossed a scoreless frame to keep the game deadlocked through nine. Shawn Armstrong worked a clean 10th, stranding Seattle’s zombie runner at second. In the bottom of the 10th, Seattle closer Andres Munoz struck out Sam Haggerty to open the inning, but Smith was hit by a pitch and Seager walked to load the bases. With one out, Marcus Semien swung at what would have been ball four and flared a 3–1 pitch off the end of his bat just beyond the second baseman’s reach, scoring Osuna for the walk-off win.`
  },
]
