...
`
  ...
  opp: 'Athletics',
  score: 'W 2-1',
  recap: `Patrick Corbin (6-7, 3.91) vs. JP Sears (7-8, 5.13). Sears is 5-0 in his last five starts against Texas. The Rangers had four base hits in the game. Seager doubled in the first and Jung singled in the second. Seager homered 434-feet to center in the third to give Texas an early 1-0 lead. The next 12 Ranger hitters failed to reach base. With two outs in the 7th, Langford walked. Heim hit a popup to shallow left field between the shortstop and the left fielder who miscommunicated allowing the ball to drop. Langford who was hustling on the play scored all the way from first what would prove to be the winning run. Corbin pitched 5-2/3, allowing a run on five hits, with no walks and seven K's. Jon Gray, in his first appearance of the season, pitched two shutout innings in relief, and Milner and Garcia closed out the win.`
  },
]
